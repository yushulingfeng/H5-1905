...
},{"process":"../../node_modules/process/browser.js"}],"../utils/httpRequest.js":[function(require,module,exports) {
"use strict";
...
},{"jquery":"../../node_modules/jquery/dist/jquery.js"}],"../utils/requesturl.js":[function(require,module,exports) {
"use strict";
...
var baseUrl = 'http://www.kl.com/src/database';
var requestUrl = {
  list: baseUrl + "/list.json",
  user: baseUrl + "/user.json",
  goods: baseUrl + "/goods.json",
  navList: baseUrl + "/navList.json",
  flashSale: baseUrl + "/flashSale.json"
};
exports.requestUrl = requestUrl;
},{}],"../lib/common.js":[function(require,module,exports) {
"use strict";
...
function tab(btns, divs, cln) {
  ...
  for (var i = 0; i < btns.length; i++) {
    ...
    btns[i].onmouseover = function () {
      ...
      this.className = cln; //下面：盒子要跟着当前的那个li显示
      // console.log(i);
...
function getTime() {
  ...
  var w = '天一二三四五六';
  w = '星期' + w.charAt(week); // switch (week) {
  //     case 0:
  //         w = '天';
  //         break;
  //     case 1:
...
function startMove(obj, json, fnend) {
  ...
  obj.timer = setInterval(function () {
    var istrue = true; //1.获取属性名，获取键名：属性名->初始值
...
},{}],"cart/addGood.js":[function(require,module,exports) {
"use strict";
...
function addGood(userId, gid, gcount) {
  var user = (0, _common.getCookie)(userId);
  ...
  if (user) {
    ...
    (0, _common.setCookie)(userId, JSON.stringify(goods));
  } else {
    (0, _common.setCookie)(userId, JSON.stringify([{
      gid: gid,
      gcount: gcount
    }]));
  }
}
},{"../../lib/common":"../lib/common.js"}],"cart/cart.js":[function(require,module,exports) {
"use strict";
...
var _addGood = require("./addGood");

var Cart = {
  addGood: _addGood.addGood
};
exports.Cart = Cart;
},{"./addGood":"cart/addGood.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _httpRequest = require("../utils/httpRequest");

var _requesturl = require("../utils/requesturl");

var _cart = require("../js/cart/cart");

//二级导航获取数据渲染
(0, _httpRequest.httpRequest)(_requesturl.requestUrl.navList, function (data) {
  // console.log(data);//数组对象
  // console.log($('.ctList'));
  var html = data.map(function (item) {
    var str = item.brand.map(function (item) {
      return " <a href=\"###\">".concat(item, "</a>");
    }).join('');
    return "<div class=\"litd\">\n                        <i class=\"underline\"></i>\n                        <div class=\"item\">\n                            <p class=\"title\">\n                                <a href=\"\">".concat(item.category, "</a>\n                            </p>\n                            <div class=\"listBox\">\n                               ").concat(str, "\n                            </div>\n                        </div>\n                    </div>");
  }).join('');
  $('.ctList').html(html);
}); //今日限时购 获取数据渲染

(0, _httpRequest.httpRequest)(_requesturl.requestUrl.flashSale, function (data) {
  // console.log(data);//数组对象
  var html = data.map(function (item) {
    return "<li data-id=".concat(item.data_id, ">\n                    <a href=\"\">\n                        <img src=\"").concat(item.imgUrl, "\" alt=\"\" title=\"").concat(item.details, "\">\n                    </a>\n                    <div class=\"detail\">\n                        <h3>\n                            <a href=\"\" title=\"").concat(item.title, "\">").concat(item.title, "</a>\n                        </h3>\n                        <h4>\n                            <a href=\"\" title=\"").concat(item.details, "\">").concat(item.details, "</a>\n                        </h4>\n                        <p class=\"price\">\n                            \uFFE5<b>").concat(item.price, "</b>\n                            <span>\uFFE5</span>\n                            <del>").concat(item.delPrice, "</del>\n                        </p>\n                        \n                        <p class=\"stock\">\n                            \u9650\u91CF").concat(item.stock, "\u4EF6\n                        </p>\n                        <a class=\"rushByBtn\" href=\"\" title=\"\u7ACB\u5373\u62A2\u8D2D\">\u7ACB\u5373\u62A2\u8D2D</a>\n                    </div>\n                </li>");
  }).join('');
  $('.goodList').html(html);
});
},{"../utils/httpRequest":"../utils/httpRequest.js","../utils/requesturl":"../utils/requesturl.js","../js/cart/cart":"cart/cart.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
